/*
*
* Модуль содержит объявления классов узлов абстрактного синтаксического дерева.
* Эти классы используются парсером в процессе построения синтаксического дерева.
*
*/
#pragma once
